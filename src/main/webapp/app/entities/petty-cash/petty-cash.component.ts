...
export class PettyCashComponent implements OnInit, OnDestroy {
    ...
    loadAll() {
        this.pettyCashService
            ...
            .subscribe(
                (res: HttpResponse<IPettyCash[]>) => this.paginatePettyCashes(res.body, res.headers),
    ...
    private paginatePettyCashes(data: IPettyCash[], headers: HttpHeaders) {
        this.links = this.parseLinks.parse(headers.get('link'));
        this.totalItems = parseInt(headers.get('X-Total-Count'), 10);
        this.queryCount = this.totalItems;
        this.pettyCashes = data;
    }
