...
import { SponsorDetailsComponent } from 'app/entities/sponsor-details/sponsor-details.component';
...
describe('Component Tests', () => {
    describe('SponsorDetails Management Component', () => {
        let comp: SponsorDetailsComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(SponsorDetailsComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.sponsorDetails[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
