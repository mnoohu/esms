...
import { ScholarshipDetailsComponent } from 'app/entities/scholarship-details/scholarship-details.component';
...
describe('Component Tests', () => {
    describe('ScholarshipDetails Management Component', () => {
        let comp: ScholarshipDetailsComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(ScholarshipDetailsComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            spyOn(service, 'query').and.returnValue(
                of(
                    new HttpResponse({
                        body: [new ScholarshipDetails(123)],
                        headers
                    })
                )
            );
            ...
            expect(comp.scholarshipDetails[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
