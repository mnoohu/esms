    ...
    describe('Receipts Service', () => {
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/receipts';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });

            it('should create a Receipts', () => {
                service.create(new Receipts(null)).subscribe(received => {
            ...
            it('should update a Receipts', () => {
                service.update(new Receipts(123)).subscribe(received => {
